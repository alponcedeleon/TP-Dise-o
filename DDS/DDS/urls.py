...
urlpatterns = [
    ...
    path('resolver_incidente/<str:id_incidente>/<int:id_comunidad>/', views.resolver_incidente, name='resolver_incidente'),
    path('comunidad/<int:id_comunidad>', views.listar_incidentes_comunidades, name='listar_incidentes_comunidades'),
