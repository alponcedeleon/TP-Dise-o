...
urlpatterns = [
    ...
    path('calcular-ranking1/', views.ranking_entidades_con_mayor_tiempo_promedio_de_tiempo_de_cierre_de_incidentes, name='calcular-ranking1'),
    path('calcular-ranking2/', views.ranking_entidades_con_mayor_incidentes_reportados_en_la_semana, name='calcular-ranking2')
]
